...
export default function LoginPage() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-2xl font-semibold tracking-tight">Sign in to ForgeMinds</CardTitle>
        <CardDescription>Your personal intelligence OS</CardDescription>
      </CardHeader>
      <CardContent>
